...
<div class="book1">
    ...
    session_start();
    $errorMessage = isset($_SESSION["adminErrorMessage"]) ? $_SESSION["adminErrorMessage"] : null;
    if ($errorMessage != null) {
        ?>
        <br><center>
            <span style="color: red;font-size: 20px;"><?php echo $errorMessage; ?></span></center>
        <?php
    ...
    <form action="Admin.php" class="book2" style="text-align: left;" method="POST">
